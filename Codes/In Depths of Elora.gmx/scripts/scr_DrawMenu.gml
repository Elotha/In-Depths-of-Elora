...

{
    ...
    if ShowFirst != "" then draw_text_transformed(room_width/2+3,154,ShowFirst,1.5,1.5,0);
    if ShowLast != "" then draw_text_transformed(room_width/2+3,168+5*32,ShowLast,1.5,1.5,0);
}
