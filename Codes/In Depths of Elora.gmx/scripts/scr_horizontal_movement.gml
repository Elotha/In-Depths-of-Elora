...

{
    if argument0
        {
        block_hor = collision_rectangle(x,y-19,x+((abs(sprite_xoffset)+8)*sign(h_speed))+h_speed,y+abs(sprite_yoffset),obj_Block,false,true); 
        block_hor2 = collision_rectangle(x,y-19,x+((abs(sprite_xoffset)+8)*sign(h_speed))+h_speed,y+abs(sprite_yoffset)-4,obj_Block,false,true); 
