...

{
    ...
    if movement_permission
        ...
        if keyboard_check(vk_left) || keyboard_check(ord('A')) then left_press = true; else left_press = false;
        if keyboard_check(vk_right) || keyboard_check(ord('D')) then right_press = true; else right_press = false;
