...

{
    ...
    if total > 1 then profiles[CURRENT_PROFILE] = "CURRENT PROFILE: " + "<" + string_upper(current_profile) + ">"; 
    else if total = 1 then profiles[CURRENT_PROFILE] = "CURRENT PROFILE: " + string_upper(current_profile);
    ...
    if total > 0
        {
        delete_profile[0] = "YES, DELETE THIS PROFILE: " + string_upper(current_profile);
